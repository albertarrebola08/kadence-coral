...
<article class="concert-card">
	...
	<div class="concert-content">
		...
		<h3 class="concert-title"><?php the_title(); ?></h3>

		<?php if ( $hora ) : ?>
			<div class="concert-hour"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				</svg> <?php echo esc_html( $hora ); ?></div>
		<?php endif; ?>

		<?php if ( $ubicacio ) : ?>
			<div class="concert-place"> <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
					<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
					<g id="SVGRepo_iconCarrier">
						<path
				...
				</svg> <?php echo wp_kses_post( $ubicacio ); ?></div>
		<?php endif; ?>
